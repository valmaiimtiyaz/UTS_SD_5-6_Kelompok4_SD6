...
/* penjelasan algoritma / logika program:
 ...
 2. Terdapat dua antrian: antrianNormal dan antrianDarurat, yang dimana:
    - antrianNormal untuk pasien biasa/ normal
    - antrianDarurat untuk pasien prioritas/darurat
 3. Program bakal ngejalanin perulangan sebanyak n kali untuk baca setiap perintah
 ...
 6. Jika perintah adalah "LAYANI" maka kita akan cek:
      - Cek apakah antrian darurat masih ada pasien
        kalo ada, pasien pertama dari antrian darurat dilayani (dikeluarkan dan ditampilkan)
      - Jika antrian darurat kosong, cek antrian normal
        kalo masih ada pasien normal, pasien pertama dari antrian normal dilayani dan ditampilkan
 7. Proses ini terus diulang sampai semua perintah selesai dibaca
 8. Hasil akhirnya adalah pasien darurat selalu dilayani lebih dulu daripada pasien normal, dan setiap pasien dilayani berdasarkan urutan kedatangan */
